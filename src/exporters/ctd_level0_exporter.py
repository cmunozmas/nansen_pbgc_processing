...
#                                }
    ...
    def create_nc_file(self, file_path, config, config_survey, data):
        ...
        z = rootgrp.createDimension("z", len(data['data'][cnv_varnames_map['TEMP00']]))
        ...
        NUMCHARS                    = len(data['attrs'][cnv_varnames_map['STATION_NAME']])
        ...
        station[:]                  = nc.stringtoarr(data['attrs'][cnv_varnames_map['STATION_NAME']], NUMCHARS, 'S')
        ...
        imr_id[:]                   = nc.stringtochar(np.array([config_survey['GlobalAttrs']['InstrumentType'] + '-' + config_survey['GlobalAttrs']['CruiseId'] + '-' + data['attrs'][cnv_varnames_map['STATION_NAME']]][0], 'S'))
        ...
        ecodepth_value              = data['attrs'][cnv_varnames_map['STATION_DEPTH']].replace(',','.')
        if ecodepth_value:
        ...
        log[:]                      = float(data['attrs'][cnv_varnames_map['STATION_SHIP_LOG']].replace(',','.'))
        log.references              = ''
        log.comment                 = ''
        log.history                 = ''
        ...
        airtemp[:]                  = float(data['attrs'][cnv_varnames_map['STATION_AIRT']].replace(',','.'))
        ...
        if cnv_varnames_map['STATION_WEATHER'] in data['data']:
            ...
            weather_value = data['attrs'][cnv_varnames_map['STATION_WEATHER']]
            if weather_value:
        ...
        if cnv_varnames_map['STATION_SKY'] in data['data']:
            ...
            sky_value               = data['attrs'][cnv_varnames_map['STATION_SKY']]
            if sky_value:
                sky[:] = float(sky_value)
            else: 
                sky[:] = np.nan
        ...
        if cnv_varnames_map['STATION_SEA'] in data['data']:
            ...
            sea_value = data['attrs'][cnv_varnames_map['STATION_SEA']]
            if sea_value:
                sea[:] = float(sea_value)
            else: 
                sea[:] = np.nan
        ...
        if data['attrs'][cnv_varnames_map['STATION_WDIR']] not in ['\n', '', ' ']:
            wdir[:] = float(data['attrs'][cnv_varnames_map['STATION_WDIR']])
        else:
            wdir[:] = np.nan
        ...
        if data['attrs'][cnv_varnames_map['STATION_WFORCE']] not in ['\n', '', ' ']:
            wforce[:] = float(data['attrs'][cnv_varnames_map['STATION_WFORCE']])
        else:
            wforce[:] = np.nan
        ...
        temp[:]                     = data['data'][cnv_varnames_map['TEMP00']][::-1].to_numpy()
        temp.valid_min              = min(data['data'][cnv_varnames_map['TEMP00']])
        temp.valid_max              = max(data['data'][cnv_varnames_map['TEMP00']])
        temp.accuracy               = 0.001
        temp.precision              = ''
        ...
        dum                             = [self.qc_flag['no_qc']] * len(data['data'][cnv_varnames_map['TEMP00']])
        ...
        pres[:]                     = data['data'][cnv_varnames_map['PRES']][::-1].to_numpy()
        pres.valid_min              = min(data['data'][cnv_varnames_map['PRES']])
        pres.valid_max              = max(data['data'][cnv_varnames_map['PRES']])
        pres.accuracy               = 0.015
        pres.precision              = ''
        ...
        dum                             = [self.qc_flag['no_qc']] * len(data['data'][cnv_varnames_map['PRES']])
        ...
        z                               = gsw.z_from_p(data['data'][cnv_varnames_map['PRES']], data['attrs'][self.nc_varnames_map['LATITUDE']])
        ...
        cndc[:]                         = data['data'][cnv_varnames_map['CNDC00']][::-1].to_numpy()
        cndc.valid_min                  = min(data['data'][cnv_varnames_map['CNDC00']])
        cndc.valid_max                  = max(data['data'][cnv_varnames_map['CNDC00']])
        ...
        cndc_qc.comment                 = ''
        cndc_qc.history                 = '' 
        dum = [self.qc_flag['no_qc']] * len(data['data'][cnv_varnames_map['CNDC00']])
        ...
        psal[:]                         = data['data'][cnv_varnames_map['PSAL00']][::-1].to_numpy()
        psal.valid_min                  = min(data['data'][cnv_varnames_map['PSAL00']])
        psal.valid_max                  = max(data['data'][cnv_varnames_map['PSAL00']])
        ...
        psal_qc.comment                 = ''
        psal_qc.history                 = '' 
        dum = [self.qc_flag['no_qc']] * len(data['data'][cnv_varnames_map['PSAL00']])
        ...
        dox1[:]                         = data['data'][cnv_varnames_map['DOX1']][::-1].to_numpy()
        dox1.valid_min                  = min(data['data'][cnv_varnames_map['DOX1']])
        dox1.valid_max                  = max(data['data'][cnv_varnames_map['DOX1']]) 
        ...
        dox1_qc.comment                 = ''
        dox1_qc.history                 = '' 
        dum = [self.qc_flag['no_qc']] * len(data['data'][cnv_varnames_map['DOX1']])
        ...
        doxv[:]                         = data['data'][cnv_varnames_map['DOXV']][::-1].to_numpy()
        doxv.valid_min                  = min(data['data'][cnv_varnames_map['DOXV']])
        doxv.valid_max                  = max(data['data'][cnv_varnames_map['DOXV']]) 
        ...
        fchla[:]                        = data['data'][cnv_varnames_map['FCHLA']][::-1].to_numpy()
        fchla.valid_min                 = min(data['data'][cnv_varnames_map['FCHLA']])
        fchla.valid_max                 = max(data['data'][cnv_varnames_map['FCHLA']]) 
        ...
        fchla_qc.comment                 = ''
        fchla_qc.history                 = '' 
        dum                              = [self.qc_flag['no_qc']] * len(data['data'][cnv_varnames_map['FCHLA']])
        fchla_qc[:]                      = np.asarray(dum) 
 

        if cnv_varnames_map['PAR'] in data['data']:
            ...
            par[:] = data['data'][cnv_varnames_map['PAR']][::-1].to_numpy()
            par.valid_min = min(data['data'][cnv_varnames_map['PAR']])
            par.valid_max = max(data['data'][cnv_varnames_map['PAR']]) 
            ...
            par_qc.comment                 = ''
            par_qc.history                 = '' 
            dum                            = [self.qc_flag['no_qc']] * len(data['data'][cnv_varnames_map['PAR']])
